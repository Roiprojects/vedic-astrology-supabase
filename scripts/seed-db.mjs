/**
 * Seed script — populates Supabase services/homams with full content from seed data.
...
if (!SUPABASE_KEY) {
  console.error("Set SUPABASE_SERVICE_ROLE_KEY or SUPABASE_ANON_KEY");
  process.exit(1);
}
