/**
 * AI Chat API route — streaming Gemini/OpenAI responses.
 * Replaces Supabase Edge Function `/functions/chat`.
 */

import { Router, Request, Response } from "express";
import { streamAI, AI_DISABLED_MESSAGE } from "../lib/ai-client";
...
router.post("/", async (req: Request, res: Response) => {
  if (!(await (await import("../lib/ai-client")).hasAnyAIKey())) {
